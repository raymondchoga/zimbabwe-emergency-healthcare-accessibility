...
**Full technical report:** [`report/ZW_Health_Access_Technical_Report.docx`](report/ZW_Health_Access_Technical_Report.docx). Covers methodology, data sources and limitations, national results, the two maps below, and six community case studies written in plain language.
...
Explore the results yourself: **[raymondchoga.github.io/zimbabwe-emergency-healthcare-accessibility](https://raymondchoga.github.io/zimbabwe-emergency-healthcare-accessibility/)**. Toggle driving/walking, switch layers on and off, and click any of the six case studies for detail.
...
docs/                Full development log (methodology, decisions, data-quality fixes) + the live map
...
web/                 Source copy of the interactive map
```
...
Steps 05 through 09 were re-run end-to-end while preparing this repository and reproduce the report's national totals to within roughly half a percentage point, and select the identical six case-study communities. Steps 01 through 04 depend on raw source data not included here (see Data Sources); minor district-name crosswalk edge cases in step 01 and a broader restricted-facility name match in step 02 mean a from-scratch re-run of the full pipeline may not reproduce `data/processed/` bit-for-bit. The shipped files are the final, reviewed versions used in the report, and are the authoritative source of truth. The scripts are provided for methodology transparency and reuse, not as a guarantee of identical output in every environment.
